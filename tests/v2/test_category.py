...
class TestCategory(unittest.TestCase):
    ...
    def test_get_all_category(self):
        ...
        self.assertEqual(
            result_get['message'], 'Categories successfully retrieved')
    ...
    def test_get_category_by_id(self):
        ...
        self.assertEqual(
            result_get_one['message'], 'Category successfully retrieved')
        self.assertEqual(response.status_code, 200)
    ...
    def test_modify_category(self):
        ...
        self.assertEqual(
            result_modify_one['message'], 'Category id 2 successfuly modified')
    ...
    def test_delete_category(self):
        ...
        self.assertEqual(
            result_delete_one['message'], 'Category id 1 successfuly deleted')
