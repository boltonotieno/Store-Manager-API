...
parser.add_argument('quantity', help='This field cannot be blank',
                    required=True)
parser.add_argument('min_quantity', help='This field cannot be blank',
                    required=True)
parser.add_argument('category_id', help='This field cannot be blank',
                    required=True)
...
class SingleProduct(Resource):
    ...
    def get(self, product_id):
        ...
        if product_id.isdigit() is False:
    ...
    def put(self, product_id):
        ...
        try:
            ...
            cursor.execute(sql, (name, price, quantity, min_quantity,
            ...
            return {
                    'message': 'Product id {} successfuly modified'
                    .format(product_id),
                    'product': data_dict
                }, 200
        except Exception as e:
    ...
    def delete(self, product_id):
        ...
        return {
                'message': 'Product id {} successfuly deleted'
                .format(product_id)
            }, 200
