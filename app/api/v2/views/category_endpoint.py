...
class SingleCategory(Resource):
    ...
    def get(self, category_id):
        """Get one Category"""
        if category_id.isdigit() is False:
            return {'message': 'Category id {} is invalid' 
                    .format(category_id)}, 400
    ...
    def put(self, category_id):
        ...
        try:
            ...
            data_dict = {
                        ...
                        'name': data[1]}        
            return {
                    'message': 'Category id {} successfuly modified'
                    .format(category_id),
                    'Category': data_dict
                }, 200
    ...
    def delete(self, category_id):
        ...
        try:
            ...
            return {
                'message': 'Category id {} successfuly deleted'
                .format(category_id)
            }, 200

        except Exception as e:
            print(e)
            return {'message': 'There exist a product with category_id {}'
                    .format(category_id)}, 400
